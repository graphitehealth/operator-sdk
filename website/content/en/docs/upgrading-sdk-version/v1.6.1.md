...
- Create the file [config/default/manager_config_patch.yaml](https://github.com/graphitehealth/operator-sdk/blob/2a1bd03/testdata/ansible/memcached-operator/config/default/manager_config_patch.yaml). 
- Create the file [config/manager/controller_manager_config.yaml](https://github.com/graphitehealth/operator-sdk/blob/2a1bd03/testdata/ansible/memcached-operator/config/manager/controller_manager_config.yaml). 
...
_See [#4701](https://github.com/graphitehealth/operator-sdk/pull/4701) for more details._
...
_See [#4734](https://github.com/graphitehealth/operator-sdk/pull/4734) for more details._
...
_See [#4654](https://github.com/graphitehealth/operator-sdk/pull/4654) for more details._
...
Ansible/Helm projects now provide a Makefile `help` target, similar to a `--help` flag. You can copy and paste this target from the relevant sample's Makefile ([helm](https://github.com/graphitehealth/operator-sdk/blob/v1.5.0/testdata/helm/memcached-operator/Makefile), [ansible](https://github.com/graphitehealth/operator-sdk/blob/v1.5.0/testdata/ansible/memcached-operator/Makefile)).

_See [#4660](https://github.com/graphitehealth/operator-sdk/pull/4660) for more details._
...
_See [#4655](https://github.com/graphitehealth/operator-sdk/pull/4655) for more details._
...
_See [#4623](https://github.com/graphitehealth/operator-sdk/pull/4623) for more details._
...
_See [#4680](https://github.com/graphitehealth/operator-sdk/pull/4680) for more details._
...
_See [#4406](https://github.com/graphitehealth/operator-sdk/pull/4406) for more details._
...
_See [#4653](https://github.com/graphitehealth/operator-sdk/pull/4653) for more details._
